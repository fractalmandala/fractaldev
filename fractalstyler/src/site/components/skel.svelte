<script module lang="ts">
  export { registerBones } from '$site/utils/skel.js'
  export type { AnimationStyle } from '$site/utils/skyp.js'

  import type { AnimationStyle } from '$site/utils/skyp.js'
...
<script lang="ts">
  ...
  import { normalizeBone } from '$site/utils/skyp.js'
  import type { AnyBone, ResponsiveBones, SkeletonResult, SnapshotConfig } from '$site/utils/skyp.js'
  import {
    adjustColor,
