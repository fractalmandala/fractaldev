...
export const CORE_TOKENS: TokenMeta[] = [
	{
		key: 'bg',
		label: 'App Canvas Base',
		category: 'surface',
		description: 'Deepest backdrop surface of the application',
		defaultVal: '#FFFFFF'
	},
	{
		key: 'bg-surface',
		label: 'Card Surface',
		category: 'surface',
		description: 'Primary card and content container background',
		defaultVal: '#F8F9FA'
	},
	{
		key: 'bg-raised',
		label: 'Raised Elements',
		category: 'surface',
		description: 'Elevated popovers, floating headers, tooltips',
		defaultVal: '#FFFFFF'
	},
	{
		key: 'bg-panel',
		...
		category: 'surface',
		description: 'Navbars, lateral sidebars, drawer panels',
		defaultVal: '#F1F3F5'
	},
	{
		key: 'bg-footer',
		...
		category: 'surface',
		description: 'Bottom footer area',
		defaultVal: '#E9ECEF'
	},
	{
		key: 'bg-popover',
		label: 'Popover & Modals',
		category: 'surface',
		description: 'Modal dialogs, dropdowns, popup menus',
		defaultVal: '#FFFFFF'
	},
	{
		key: 'bg-dialog',
		...
		category: 'surface',
		description: 'Dialog card background',
		defaultVal: '#FFFFFF'
	},
	{
		key: 'bg-terminal',
		label: 'Code & Terminal',
		category: 'surface',
		description: 'Terminal blocks and code view background',
		defaultVal: '#0F172A'
	},
	{
		key: 'bg-input',
		label: 'Form Inputs',
		category: 'surface',
		description: 'Input fields, textareas, select boxes',
		defaultVal: '#FFFFFF'
	},
	{
		key: 'bg-canvas',
		...
		category: 'surface',
		description: 'Outer workspace canvas background',
		defaultVal: '#F8F9FA'
	},
	{
		key: 'border',
		...
		category: 'border',
		description: 'Primary borders, card outlines, separators',
		defaultVal: '#E2E8F0'
	},
	{
		key: 'border-subtle',
		label: 'Subtle Border',
		category: 'border',
		description: 'Faint divider lines and inner item borders',
		defaultVal: '#EDF2F7'
	},
	{
		key: 'text-primary',
		label: 'Primary Text',
		category: 'typography',
		description: 'Headings, titles, high-contrast text',
		defaultVal: '#0F172A'
	},
	{
		key: 'text-secondary',
		...
		category: 'typography',
		description: 'Body paragraphs, descriptions, labels',
		defaultVal: '#475569'
	},
	{
		key: 'text-muted',
		label: 'Muted Text',
		category: 'typography',
		description: 'Captions, timestamps, metadata',
		defaultVal: '#7F91AA'
	},
	{
		key: 'text-inverse',
		label: 'Inverse Text',
		category: 'typography',
		description: 'Contrast text on brand/accent buttons',
		defaultVal: '#FFFFFF'
	},
	{
		key: 'state-hover',
		label: 'Hover State',
		category: 'state',
		description: 'Background tint on button and card hover',
		defaultVal: '#E2E8F0'
	},
	{
		key: 'state-hover-subtle',
		label: 'Subtle Hover',
		category: 'state',
		description: 'Gentle hover state on list items',
		defaultVal: '#F1F5F9'
	},
	{
		key: 'state-selected',
		...
		category: 'state',
		description: 'Active tab, selected item highlight',
		defaultVal: '#CBD5E1'
	},
	{
		key: 'theme-color',
		label: 'Brand Accent',
		category: 'accent',
		description: 'Primary brand action color, active badges, highlights',
		defaultVal: '#04825B'
	},
	{
		key: 'theme-color-alt',
		...
		category: 'accent',
		description: 'Hover state for brand accent buttons',
		defaultVal: '#047857'
	}
];
	...
	},
	{
		...
		layers: [
			...
			},
			{
				layer: 2,
				background:
					'repeating-linear-gradient( 100deg, #262626 0%, #262626 3%, rgba(38, 38, 38, 0.7) 5%, rgba(38, 38, 38, 0.7) 7%, transparent 10%, transparent 12%, rgba(38, 38, 38, 0.7) 14%, #262626 16% ), repeating-linear-gradient( 100deg, #9ca3af 0%, #9ca3af 1.5%, rgba(156, 163, 175, 0.8) 2%, #6b7280 3%, #6b7280 4%, rgba(156, 163, 175, 0.8) 4.5%, #9ca3af 5% )',
				blendMode: 'screen',
				blurMobile: 75,
				blurDesktop: 108,
				opacity: 0.9
	...
	},
	{
		...
		layers: [
			...
			},
			{
				layer: 4,
				background:
					'radial-gradient(circle at 10% 10%, rgba(255,255,255,0.7) 1px, transparent 3px), radial-gradient(circle at 88% 15%, rgba(255,255,255,0.6) 1px, transparent 3px), radial-gradient(circle at 40% 90%, rgba(255,255,255,0.6) 1px, transparent 3px)',
				blendMode: 'screen',
				blurMobile: 75,
				blurDesktop: 100,
				opacity: 0.8
	...
	},
	{
		...
		layers: [
			...
			},
			{
				layer: 4,
				background:
					'radial-gradient(circle at 20% 20%, rgba(255,255,255,0.8) 1px, transparent 3px), radial-gradient(circle at 70% 12%, rgba(250,232,255,0.9) 1.5px, transparent 4px), radial-gradient(circle at 88% 55%, rgba(255,255,255,0.7) 1px, transparent 3px), radial-gradient(circle at 12% 60%, rgba(233,213,255,1) 1.5px, transparent 4px), radial-gradient(circle at 40% 8%, rgba(255,255,255,0.6) 1px, transparent 3px)',
				blendMode: 'screen',
				blurMobile: 75,
				blurDesktop: 100,
				opacity: 1
	...
	},
	{
		...
		layers: [
			...
			},
			{
				layer: 4,
				background:
					'radial-gradient(circle at 14% 22%, rgba(255,255,255,0.8) 1px, transparent 3px), radial-gradient(circle at 76% 30%, rgba(209,250,229,0.9) 1.5px, transparent 4px), radial-gradient(circle at 85% 75%, rgba(255,255,255,0.7) 1px, transparent 3px), radial-gradient(circle at 25% 78%, rgba(250,232,255,1) 1.5px, transparent 4px)',
				blendMode: 'screen',
				blurMobile: 75,
				blurDesktop: 100,
				opacity: 1
	...
	},
	{
		...
		layers: [
			...
			},
			{
				layer: 4,
				background:
					'radial-gradient(circle at 20% 20%, rgba(255,255,255,0.6) 1px, transparent 3px), radial-gradient(circle at 78% 25%, rgba(255,255,255,0.5) 1px, transparent 3px), radial-gradient(circle at 55% 80%, rgba(255,255,255,0.5) 1px, transparent 3px)',
				blendMode: 'screen',
				blurMobile: 75,
				blurDesktop: 100,
				opacity: 0.7
	...
	},
	{
		...
		layers: [
			...
			},
			{
				layer: 2,
				background:
					'repeating-linear-gradient( 100deg, #331100 0%, #331100 3%, rgba(80, 30, 10, 0.7) 5%, rgba(80, 30, 10, 0.7) 7%, transparent 10%, transparent 12%, rgba(80, 30, 10, 0.7) 14%, #331100 16% ), repeating-linear-gradient( 100deg, #ff6b00 0%, #ff6b00 1.5%, rgba(255, 107, 0, 0.8) 2%, #b91c1c 3%, #b91c1c 4%, rgba(255, 107, 0, 0.8) 4.5%, #ff6b00 5% )',
				blendMode: 'screen',
				blurMobile: 75,
				blurDesktop: 108,
				opacity: 0.9
	...
	},
	{
		...
		layers: [
			...
			},
			{
				layer: 2,
				background:
					'repeating-linear-gradient( 100deg, #041022 0%, #041022 3%, rgba(20, 60, 120, 0.7) 5%, rgba(20, 60, 120, 0.7) 7%, transparent 10%, transparent 12%, rgba(20, 60, 120, 0.7) 14%, #041022 16% ), repeating-linear-gradient( 100deg, #b3e5ff 0%, #b3e5ff 1.5%, rgba(179, 229, 255, 0.8) 2%, #2563eb 3%, #2563eb 4%, rgba(179, 229, 255, 0.8) 4.5%, #b3e5ff 5% )',
				blendMode: 'screen',
				blurMobile: 75,
				blurDesktop: 108,
				opacity: 0.9
	...
	},
	{
		...
		layers: [
			...
			},
			{
				layer: 3,
				background:
					'radial-gradient(circle at 15% 20%, rgba(255,255,255,0.9) 1.5px, transparent 4px), radial-gradient(circle at 78% 15%, rgba(199,210,254,0.9) 1.5px, transparent 4px), radial-gradient(circle at 88% 60%, rgba(255,255,255,0.8) 1.5px, transparent 4px), radial-gradient(circle at 30% 75%, rgba(255,255,255,0.8) 1.5px, transparent 4px), radial-gradient(circle at 55% 85%, rgba(199,210,254,0.9) 1.5px, transparent 4px)',
				blendMode: 'screen',
				blurMobile: 75,
				blurDesktop: 100,
				opacity: 1
