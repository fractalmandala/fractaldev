...
export const frameworkFeatures = [
	{
		...
		items: [
			...
			{ text: 'Installable PWA with offline support', color: 'bg-yellow-400' }
		]
	},
	{
		title: 'Dev Stack',
		items: [
			{ text: 'Static-first, no backend required', color: 'bg-pink-400' },
...
export const stackFooterText = 'Pre-built components, ready to drop into any SvelteKit app.';
