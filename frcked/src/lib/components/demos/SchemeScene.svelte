<script lang="ts">
	...
	import type { RoleKey } from '$lib/data/schemeTypes';
	import type { SceneId } from '$lib/states/playground.svelte';
	import { inkOn, contrastRatio } from '$lib/utilities/colorUtils';
