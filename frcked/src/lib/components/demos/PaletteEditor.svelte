<script lang="ts">
	...
	import { ROLE_KEYS, ROLE_LABELS, type RoleKey } from '$lib/data/schemeTypes';
	import { playground } from '$lib/states/playground.svelte';
	import { contrastGrade, contrastRatio } from '$lib/utilities/colorUtils';
