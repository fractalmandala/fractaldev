---
title: Presets and Runtime Tuning
description: Reference guide for Fractalstyler2's four preset tuning axes (Layout, Shape, Color, Motion), Svelte 5 runtime state, UI pickers, and zero-flicker head scripts.
id: 5
type: docs
---
