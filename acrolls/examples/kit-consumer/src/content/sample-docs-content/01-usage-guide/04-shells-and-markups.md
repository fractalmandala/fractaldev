---
title: Shells and Canonical Markups
description: Reference guide for Level 4 shell fractals, canonical application markup structures, role-bound sidebars, mobile disclosure physics, and interactive overlays.
id: 8
type: Usage Guide
---

Level 4 (L4) fractals provide complete page and application scaffolding. In Fractalstyler, an L4 class without a canonical markup is considered an incomplete definition: every shell class is paired with an authored, semantic HTML markup structure.

## Canonical App Shell

Canonical app shell markup and styling establish the viewport frame, sticky chrome, and different layout templates. Canonical App Shell can be used in one of two ways. The provided AppShell.svelte component and its accompaniments are 
