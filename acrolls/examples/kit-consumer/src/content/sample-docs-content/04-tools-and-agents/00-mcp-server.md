---
title: MCP and CLI
description: Reference guide for the Fractalstyler2 Model Context Protocol server and CLI covering tool schemas, compilation, snapping, and IDE agent configuration.
id: 11
type: docs
---
