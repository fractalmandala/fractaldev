...
description: Practical, copy-pasteable UI component recipes demonstrating how to build complex real-world interfaces using 100% pure Fractalstyler2 classes with ZERO custom SASS.
id: 13
type: docs
---
