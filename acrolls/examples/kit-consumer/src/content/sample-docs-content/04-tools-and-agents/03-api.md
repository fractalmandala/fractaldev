---
title: API Reference
description: Complete reference for everything fractalstyler2 exports — entry points, the preset and theming runtime, the reactive mirror, shell components, and the six pickers.
id: 14
type: docs
---
